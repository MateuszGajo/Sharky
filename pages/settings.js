...
import C from '../pages_/settings'
import ns0 from '../public/locales/pl/common.json'
import ns1 from '../public/locales/pl/component.json'
import ns2 from '../public/locales/pl/settings.json'

const namespaces = { 'common': ns0, 'component': ns1, 'settings': ns2 }
